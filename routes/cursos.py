...
def home():
    ...
    cursos = Curso.query.join(Aula, Curso.aula_id==Aula.idAula).join(Turno, Curso.turno_id==Turno.idTurno).add_columns(Curso.idCurso, Curso.curso, Curso.division, Curso.periodo, Aula.nombre, Aula.capacidad, Aula.ubicacion, Turno.turno)
